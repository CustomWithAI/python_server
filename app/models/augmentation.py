...
class DataAugmentationConfig(BaseModel):
    grayscale: Optional[float] = Field(None, description="Convert image to grayscale.")
    resize: Optional[Tuple[int, int]] = Field(None, description="Resize image to (width, height).")
    crop: Optional[Tuple[float, Tuple[int, int], Tuple[int, int]]] = Field(None, description="Crop a region (x, y, width, height).")
    ...
    histogram_equalization: Optional[Tuple[float]] = Field(None, description="Apply histogram equalization.")
