...
class ConvolutionalLayer(BaseModel):
    ...
    convolutionalLayer_activation: Literal['relu', 'sigmoid', 'tanh',
                                           'elu', 'selu', 'softplus', 'softsign', 'linear', 'softmax'] = 'relu'
...
class NormalizationLayer(BaseModel):
    normalizationLayer_type: Literal['BatchNormalization',
                                     'LayerNormalization']
...
class ActivationLayer(BaseModel):
    activationLayer_function: Literal['relu', 'sigmoid', 'tanh', 'elu',
                                      'selu', 'softplus', 'softsign', 'linear', 'softmax'] = 'relu'
...
class DenseLayer(BaseModel):
    ...
    denseLayer_activation: Literal['relu', 'sigmoid', 'tanh', 'elu',
                                   'selu', 'softplus', 'softsign', 'linear', 'softmax'] = 'relu'
